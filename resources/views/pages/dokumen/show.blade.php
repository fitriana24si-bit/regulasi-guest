    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    @if ($isImage)
                                        <img src="{{ Storage::url($dokumen->file_path) }}" alt="Dokumen"
                ...
                @if ($dokumen->lampiran && $dokumen->lampiran->count())
                    <div class="card shadow mb-4">
                            ...
                            @foreach ($dokumen->lampiran as $lampiran)
                                @foreach ($lampiran->media as $media)
                                    @php
                                        ...
                                        $fileUrl = Storage::url('lampiran/' . $media->file_name);
                                    @endphp
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card h-100 shadow-sm">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                <h6 class="text-truncate">{{ $media->file_name }}</h6>
                                                ...
                                                <div class="mt-auto d-flex gap-2">
                                                    ...
                                                    <a href="{{ route('lampiran.media.download', $media->media_id) }}"
                ...
                <div class="col-lg-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body text-center">
                            <div
                                class="status-indicator {{ $dokumen->status == 'aktif' ? 'status-active' : 'status-inactive' }} mb-3">
                                <i
                                    class="fas {{ $dokumen->status == 'aktif' ? 'fa-check-circle' : 'fa-times-circle' }} fa-3x"></i>
                            </div>
